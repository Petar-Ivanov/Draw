...
{
    /// <summary>
    /// Класът триъгълник е основен примитив, който е наследник на базовия Shape.
    /// </summary>
    [Serializable]
    public class TriangleShape : Shape
	{
        ...
        public static int TriangleCounter = 1;

        #region Constructor

        public TriangleShape(RectangleF rect) : base(rect)
		{
            this.Name = $"Triangle{TriangleCounter++}";
        }
        ...
        /// <summary>
		/// Проверява за принадлежност на точка p към триъгълника.
        ...
        {
            TriangleShape copy = new TriangleShape(new RectangleF(Rectangle.X, Rectangle.Y, Rectangle.Width, Rectangle.Height));
            copy.Name = Name;
        ...
        public override void DrawSelf(Graphics grfx)
		{
            ...
            Point[] trianglePoints = new Point[]
            {
				...
				new Point((int) Rectangle.X, (int)Rectangle.Y + (int)Rectangle.Height),
				new Point((int)Rectangle.X + (int)Rectangle.Width, (int)Rectangle.Y + (int)Rectangle.Height)
            };
            ...
            grfx.FillPolygon(brush, trianglePoints);
            grfx.DrawPolygon(new Pen(Color.FromArgb(BorderColorOpacity, BorderColor), BorderRadius), trianglePoints);
