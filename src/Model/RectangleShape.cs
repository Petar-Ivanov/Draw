...
namespace Draw
{
    ...
    public class RectangleShape : Shape
	{
        ...
        public static int RectangleCounter = 1;
        ...
        /// <summary>
		/// Проверява за принадлежност на точка p към правоъгълника.
        ...
        public override Shape CopySelf()
        {
            ...
            RectangleShape copy = new RectangleShape(new RectangleF(Rectangle.X, Rectangle.Y, Rectangle.Width, Rectangle.Height));
            copy.Name = Name;
        ...
        public override void DrawSelf(Graphics grfx)
        {
            ...
            grfx.DrawRectangle(new Pen(Color.FromArgb(BorderColorOpacity, BorderColor), BorderRadius), Rectangle.X, Rectangle.Y, Rectangle.Width, Rectangle.Height);
